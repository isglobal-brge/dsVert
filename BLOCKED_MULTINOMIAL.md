# Multinomial promotion blocked — 2026-09-18 resumed audit
...
budget. Wire the exact boundaries in `INTEGRATION_MULTINOMIAL.md`, then run
...
Package check results and final commits are recorded in `STATUS_MULTINOMIAL.md`.
