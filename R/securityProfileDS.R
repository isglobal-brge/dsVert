...
.dsvert_disclosure_safe_remote_methods <- c(
  ...
  "dsvertDPSynopsisBootstrapDS",
  "dsvertDPSynopsisBindDS",
  "dsvertDPSynopsisClaimDS",
  "dsvertDPSynopsisCompileDS",
  ...
  "dsvertDPSynopsisSourcePrepareDS",
  "dsvertDPSynopsisSourceChunkDS",
  "dsvertDPSynopsisSourceAcceptDS",
  "dsvertDPSynopsisPublicationDS",
  ...
  list(
    ...
    route_claims = list(
      ...
      formal_cox_fresh_source_state = paste0(
        "configured_snapshot_ticket_encrypted_ingress_and_worker_relay_only_",
        "no_public_result"),
      formal_cox_worker_control_ready = TRUE,
      formal_cox_worker_control_state = paste0(
        "provisioned_burned_host_closed_authenticated_relay_only_",
        "no_public_model_result"),
