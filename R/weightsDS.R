...
#'   stores or seals those shares for the two DCF parties. Unlike the
#'   removed plaintext-weight route, this helper never gives either DCF
#'   party the full patient-level weights vector.
#'
