...
Active profile: `cross-grid-ordinal-piecewise-q16-v1`.
...
`MASS::polr`. Sticky replay is identical and the public release fails
closed outside the lexical test-only release mock. No standard errors are
returned. Central fit NLL=10497.987829558; exact best grid
NLL=10500.508386549. Maximum observed row error is
6.473923498e-06; maximum observed candidate-total error is
0.0210971207.

The full-domain certificate is conservative for this small 3-candidate grid:
its worst-case n*error/noise ratio at epsilon 8 is 1.081200.
...
| ---: | ---: | ---: | ---: |
| 2 | 18,172 | 581,520 | 290.760 |
| 3 | 31,709 | 1,014,704 | 507.352 |
| 8 | 33,144 | 1,060,624 | 530.312 |
...
See `BLOCKED_ORDINAL.md` and `INTEGRATION_ORDINAL.md`. No epsilon/delta/cap,
