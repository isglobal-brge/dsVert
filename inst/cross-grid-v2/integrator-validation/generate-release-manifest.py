...
UNWIRED = ["lmm", "binomial_glmm", "poisson_glmm", "binomial_gee", "poisson_gee", "cox"]
...
def main():
        ...
        for epsilon in (1, 4, 8):
            for owners in (2, 3, 5):
                ...
                for instance in range(1, 21):
                    ...
                    predictors = 3 if family.endswith("_gee") else 6
                    env = {
    ...
    print(f"Wrote {len(rows)} pending release jobs; six family harnesses await producer integration and authenticated proof.")
